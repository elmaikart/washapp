  ...
  return (
    <div className="px-4 py-6 pb-28">
      ...
      <div className="flex items-center justify-center mt-6 mb-6">
        <div className="flex items-center w-full max-w-md gap-2 rounded-full border border-gray-300 bg-white px-3 py-2 shadow-sm focus-within:ring-2 focus-within:ring-wash-primary">
          <Input
            type="text"
          ...
          />
          <button className="bg-[#002b45] text-white px-4 py-1.5 text-sm rounded-full hover:bg-[#001f33] transition-colors">
            Buscar
          </button>
        </div>
      </div>
