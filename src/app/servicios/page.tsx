  ...
  return (
    <div className="px-4 py-6 pb-28">
      ...
      <div className="flex items-center justify-center mt-6">
        <div className="flex items-center w-full max-w-md rounded-full border border-gray-300 overflow-hidden shadow-sm bg-white">
          {/* Ícono lupa */}
          ...
          />
          {/* Botón */}
          <button className="bg-wash-primary hover:bg-[#001a2e] text-white px-4 py-2 text-sm font-semibold rounded-r-full">
            Buscar
          </button>
        </div>
      </div>
      ...
      {/* Servicios */}
      <h2 className="text-lg font-semibold text-gray-900 mt-6 mb-4">Servicios</h2>
