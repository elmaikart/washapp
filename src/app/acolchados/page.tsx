...
const prendasBlancas = [
  { title: "1 Plaza", desc: "Prendas blancas - servicio económico", price: 10000 },
  { title: "2 Plazas", desc: "Prendas blancas con blanqueador - servicio económico", price: 12000 },
  { title: "+2 Plazas", desc: "Prendas blancas con Skip + Confort", price: 13000 },
];

const prendasColor = [
  { title: "1 Plaza", desc: "Prendas de color - servicio económico", price: 10000 },
  { title: "2 Plazas", desc: "Prendas de color con Skip + Confort", price: 13000 },
  { title: "+2 Plazas", desc: "Solo servicio de secado", price: 7000 },
];
      ...
      <main className="flex-1 px-4 py-6 overflow-y-auto">
        <div className="grid grid-cols-2 gap-4 gap-6">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-[#0A2A45] mb-2">Acolchados de Plumas</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-[#0A2A45] mb-2">Acolchados Sintéticos</h3>
